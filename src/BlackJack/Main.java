...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        game.addPlayerToGame(player1); // добавляем игроков в игру
        game.addPlayerToGame(player2);
        game.addPlayerToGame(player3);

        game.dealTwoCard(); // раздает каждому по 2 карты
        game.addCardsToPlayer(); // спрашивает каждого игрока, если да - то выдает карту

        game.printWinner(); // определяет победителей
